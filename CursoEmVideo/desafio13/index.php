...
<body>
    ...
    <section id="resultado">
        ...
        <ul>
            <li><img src="/CursoEmVideo/desafio13/100.jpg" alt=""> x <?= $tot100 ?></li>
            <li><img src="/CursoEmVideo/desafio13/50.jpg" alt=""> x <?= $tot50 ?></li>
            <li><img src="/CursoEmVideo/desafio13/10.jpg" alt=""> x <?= $tot10 ?></li>
            <li><img src="/CursoEmVideo/desafio13/5.jpg" alt=""> x <?= $tot5 ?></li>
        </ul>
