...
<body>
    ...
    <main>
        ...
        <form action="<?= $_SERVER['PHP_SELF'] ?>" method="get">
            ...
            <label for="reajuste">Qual será o percentual de reajuste?(<strong
                    id="valorVolume"><?= $reajuste ?></strong>%)</label>

            <input type="range" id="reajuste" name="reajuste" min="0" max="100"
                value="<?php echo $_GET['reajuste'] ?? 50; ?>"
